...
namespace HTPT
{
    internal static class Program
    {
        ...
        public static String connstr_publiser = @"Data Source=DESKTOP-A9GGGCL\HOANG;Initial Catalog=TN_HTPT;Integrated Security=True";
