...
namespace HTPT
{
    public partial class FrmFilterXemKQThi : Form
    {
        ...
        {
            this.tbMHocADT.Connection.ConnectionString = Program.connstr;
        ...
        private void btnLoc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    String ngaythi = "exec SP_GET_NGAYTHI N'"
                  + Program.username + "', N'"
                  + txtMaMon.Text.Trim() + "', "
                  + cbbLanThi.Text.Trim();
                    try
                    {
                        ...
                        rptKQT rpt = new rptKQT(txtMaSV.Text.Trim(), txtMaMon.Text.Trim(), Int32.Parse(cbbLanThi.Text.Trim()));
